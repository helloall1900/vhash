...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct storage_base {
            ...
            /**
             * Call this to create user defined scalar function. Can be called at any time no matter connection is has_opened or no.
            ...
            /**
             * Call this to create user defined aggregate function. Can be called at any time no matter connection is has_opened or no.
            ...
            /**
             * Checks whether connection to database is has_opened right now.
